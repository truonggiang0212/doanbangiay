      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            @else
            <td>{{ number_format($coupon->coupon_number)}} VND</td>
            @endif
            <td>{{ $coupon->coupon_qty }}</td>
            <td>
              <a href="{{URL::to('/edit-coupon/'.$coupon->coupon_id)}}" class="active styling-edit" ui-toggle-class="">
                <i class="fa fa-pencil-square-o text-success text-active"></i>
                <a onclick="return confirm('Bạn chắc chắn muốn xóa không?')" href="{{URL::to('/delete-coupon/'.$coupon->coupon_id)}}" class="active styling-edit" ui-toggle-class="">
